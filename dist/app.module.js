    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                password: 'Tinkal$$6',
                database: 'STM_DB',
                entities: [role_entity_1.Role, user_entity_1.User, ticket_entity_1.Ticket, ticket_comment_entity_1.TicketComment, ticket_status_log_entity_1.TicketStatusLog],
                synchronize: false,
            }),
